...
import { Asset, AssetCategory, AssetStatus, Expense, ExpenseCategory, MaintenanceRecord, Notification, OSPriority, OSStatus, OSType, PaymentMethod, PersonalTask, ServiceOrder, Supplier, Unit, User } from './types';
...
export const MOCK_TASKS: PersonalTask[] = [
    {
        ...
        dueDate: '2026-05-27T09:00:00.000Z',
        completed: false,
        priority: 'high',
        linkedOSId: 'OS-26010'
    },
...
export const MOCK_ORDERS: ServiceOrder[] = [
  {
    ...
    dateClosed: '2026-01-07T16:00:00.000Z',
    archived: true,
    history: [],
  },
  {
    ...
    dateClosed: '2026-01-10T14:00:00.000Z',
    archived: true,
    history: [],
  },
  {
    ...
    dateClosed: '2026-02-03T18:00:00.000Z',
    archived: true,
    history: [],
  },
  {
    ...
    dateClosed: '2026-02-15T09:00:00.000Z',
    archived: true,
  ...
  },
  {
    ...
    dateClosed: '2026-03-12T10:00:00.000Z',
    archived: true,
    history: [],
  },
  {
    ...
    dateClosed: '2026-04-05T17:00:00.000Z',
    archived: true,
    history: [],
  },
  {
